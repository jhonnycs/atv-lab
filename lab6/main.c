...
void exibirMenu() {
    ...
    printf(" 5. Mostrar finanças de uma pessoa\n");
    printf(" 6. Ordenar finanças por data\n");
    printf(" 7. Ordenar finanças por tipo\n");
    printf(" 8. Ordenar finanças por valor\n");
    printf(" 9. Agrupar por tipo e ordenar por data\n");
    printf("10. Agrupar por tipo e ordenar por valor\n");
    printf("11. Atualizar investimento\n");
    printf("12. Exibir valor bruto total\n");
    printf("13. Exibir valor líquido total\n");
    printf(" 0. Sair\n");
...
int main() {
    ...
    while (1) {
        ...
        switch (opcao) {
            ...
            case 5: {                // Mostrar uma finança de uma pessoa
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
            ...
            case 6: {               // Ordenar finanças por data
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
                if (idPessoa < 0 || idPessoa >= quantPessoas) {
                    printf("ID de pessoa inválido.\n");
            ...
            case 7: {                // Ordenar finanças por tipo
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
                if (idPessoa < 0 || idPessoa >= quantPessoas) {
                    printf("ID de pessoa inválido.\n");
            ...
            case 8: {                // Ordenar finanças por valor
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
                if (idPessoa < 0 || idPessoa >= quantPessoas) {
                    printf("ID de pessoa inválido.\n");
            ...
            case 9: {                // Agrupar por tipo e ordenar por data
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
                if (idPessoa < 0 || idPessoa >= quantPessoas) {
                    printf("ID de pessoa inválido.\n");
            ...
            case 10: {                // Agrupar por tipo e ordenar por valor
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
                if (idPessoa < 0 || idPessoa >= quantPessoas) {
                    printf("ID de pessoa inválido.\n");
            ...
            case 11: {              // atualizar investimento
                printf("Digite o ID da pessoa:\n> ");
                scanf("%d", &idPessoa);
                printf("Digite o índice da finança:\n> ");
                scanf("%d", &indexFinanca);
